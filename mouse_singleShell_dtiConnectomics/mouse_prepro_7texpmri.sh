...
for_each * : dwi2fod msmt_csd IN/mrtrix/dwi_den_unr_pre_pos_unbiasantx_unbias_up_pos.mif IN/mrtrix/csf.txt IN/mrtrix/csf.mif IN/mrtrix/wm.txt IN/mrtrix/wm.mif -mask IN/mrtrix/maskantx_up_smooth_thresh_erode.mif

#remove remaining intensity variations, gives error therefore comment out
#for_each * : mtnormalise IN/mrtrix/csf.mif IN/mrtrix/csf_norm.mif IN/mrtrix/wm.mif IN/mrtrix/wm_norm.mif -mask IN/mrtrix/maskantx_up.mif
